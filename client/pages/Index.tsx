...
import { Users, FileText, Package, CheckCircle, UserPlus, Settings, TrendingUp, Calendar, Bell, Search } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-2xl font-bold text-gray-900">Associate 360</h1>
              </div>
      ...
      <nav className="bg-white border-b border-gray-200">
        <div className="px-6">
          <div className="flex space-x-8">
            <Link to="/" className="border-b-2 border-primary text-primary py-4 px-1 text-sm font-medium">
              Dashboard
            </Link>
            <Link to="/jobs" className="border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 py-4 px-1 text-sm font-medium">
              Job Management
            </Link>
            <Link to="/procurement" className="border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 py-4 px-1 text-sm font-medium">
              Procurement
            </Link>
            <Link to="/assets" className="border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 py-4 px-1 text-sm font-medium">
              Asset Management
            </Link>
            <Link to="/clearance" className="border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 py-4 px-1 text-sm font-medium">
              Clearance
            </Link>
            <Link to="/reports" className="border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 py-4 px-1 text-sm font-medium">
              Reports
            </Link>
          </div>
        </div>
