    ...
    <div className="px-6 py-8">
      ...
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">
          Welcome to Associate 360
        </h2>
        <p className="text-lg text-gray-600">
          Comprehensive platform for managing off-role employees under T&M
          agreement - from hiring to offboarding
        </p>
      </div>
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm text-gray-500">
                        Post new position requirements
                      </div>
                    </div>
                  </Button>
                </Link>
                ...
                <Link to="/assets/allocate">
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm text-gray-500">
                        Assign equipment to associates
                      </div>
                    </div>
                  </Button>
                </Link>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium">
                      Job ID: JOB-2024-0156 approved
                    </p>
                    <p className="text-xs text-gray-500">
                      Software Developer position for IT Department • 2 hours
                      ago
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Laptop LP-2024-0234 assigned to John Smith • 4 hours ago
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Sarah Johnson - LWD in 3 days • 6 hours ago
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Mobile phone MP-2024-0123 from Mike Davis • 8 hours ago
                    </p>
                  </div>
                </div>
              </div>
