...
import { BarChart, TrendingUp, DollarSign, FileText, Download, Calendar, Filter, Search, Eye, ExternalLink, Plus, Settings, User, Package, Clock, AlertTriangle, CheckCircle } from 'lucide-react';
...
interface CustomReport {
  ...
  name: string;
  description: string;
  type: 'Asset History' | 'Utilization' | 'Cost Analysis' | 'Compliance' | 'Custom Query';
  filters: any;
  schedule?: string;
...
export default function ReportsAnalytics() {
  ...
  const customReports: CustomReport[] = [
    {
      ...
      description: 'Monthly report showing asset utilization across all departments',
      type: 'Utilization',
  ...
  const getTrendIcon = (trend: string) => {
    switch (trend) {
      ...
      case 'stable': return <div className="w-4 h-0.5 bg-gray-600"></div>;
      default: return null;
    }
  };
  ...
  const handleCreateCustomReport = () => {
    const newReport: CustomReport = {
      ...
      recipients: customReportForm.recipients.split(',').map(email => email.trim()),
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-gray-600">Comprehensive insights and analytics for asset management</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Monthly asset allocation and return patterns</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Asset costs by department for current quarter</CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium">15 assets allocated this week</p>
                      <p className="text-xs text-gray-500">Mostly laptops and mobile devices</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium">8 maintenance requests completed</p>
                      <p className="text-xs text-gray-500">Average resolution time: 2.3 days</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium">3 compliance alerts resolved</p>
                      <p className="text-xs text-gray-500">All within SLA timeframes</p>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="p-3 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-sm text-blue-700">Consider bulk purchase of monitors - 23% cost savings predicted</p>
                  </div>
                  
                  <div className="p-3 bg-yellow-50 rounded-lg">
                    <p className="text-sm font-medium text-yellow-800">Alert</p>
                    <p className="text-sm text-yellow-700">12 assets approaching warranty expiration next month</p>
                  </div>
                  
                  <div className="p-3 bg-green-50 rounded-lg">
                    <p className="text-sm font-medium text-green-800">Insight</p>
                    <p className="text-sm text-green-700">Asset utilization up 15% - optimization working well</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Detailed tracking of all asset movements and changes</CardDescription>
                </div>
                <div className="flex gap-2">
                ...
                <TableBody>
                  {assetHistory.map((record) => (
                    <TableRow key={record.id}>
                      <TableCell>
                        <div>
                          <div className="font-medium">{record.associateName}</div>
                          <div className="text-sm text-gray-500">{record.associateId}</div>
                        </div>
                      </TableCell>
                      <TableCell>
                        <div>
                          <div className="font-medium">{record.assetName}</div>
                          <div className="text-sm text-gray-500">{record.serialNumber}</div>
                        </div>
                      </TableCell>
                      <TableCell>
        ...
        <TabsContent value="utilization" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Utilization rates across different asset categories</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                    ...
                    <div key={report.category} className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">{report.utilizationRate}%</span>
                        </div>
                      </div>
                      <Progress value={report.utilizationRate} className="h-2" />
                      <div className="flex justify-between text-xs text-gray-500">
                        <span>{report.allocatedAssets}/{report.totalAssets} allocated</span>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Monthly utilization patterns and forecasts</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <div className="p-3 bg-blue-50 rounded-lg">
                        <p className="text-sm font-medium text-blue-800">Monitors</p>
                        <p className="text-xs text-blue-700">5 underutilized units - consider reallocation</p>
                      </div>
                      <div className="p-3 bg-green-50 rounded-lg">
                        <p className="text-sm font-medium text-green-800">Software Licenses</p>
                        <p className="text-xs text-green-700">High utilization - consider bulk renewal</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Comprehensive utilization data by category</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                ...
                <TableBody>
                  {utilizationReports.map((report) => (
                    <TableRow key={report.category}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <Progress value={report.utilizationRate} className="w-20 h-2" />
                          <span className="text-sm">{report.utilizationRate}%</span>
                        </div>
                      </TableCell>
        ...
        <TabsContent value="cost-tracking" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600">Total Asset Investment</p>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detailed cost breakdown and budget variance analysis</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                ...
                <TableBody>
                  {costReports.map((report) => (
                    <TableRow key={report.id}>
                      ...
                      <TableCell>${report.acquisitionCost.toLocaleString()}</TableCell>
                      <TableCell>${report.maintenanceCost.toLocaleString()}</TableCell>
                      <TableCell>
                        <span className={report.roi > 15 ? 'text-green-600' : 'text-red-600'}>
                          {report.roi}%
                        </span>
                      </TableCell>
                      <TableCell>
                        <span className={report.budgetVariance > 0 ? 'text-red-600' : 'text-green-600'}>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="p-4 border rounded-lg">
                    <h4 className="font-medium text-green-800">Bulk License Renewal</h4>
                    <p className="text-sm text-gray-600">Potential savings: $15,000/year</p>
                    <p className="text-xs text-gray-500">Consolidate software licenses across departments</p>
                  </div>
                  
                  <div className="p-4 border rounded-lg">
                    <h4 className="font-medium text-blue-800">Asset Lifecycle Extension</h4>
                    <p className="text-sm text-gray-600">Potential savings: $8,500/year</p>
                    <p className="text-xs text-gray-500">Extend laptop lifecycle to 4 years with upgrades</p>
                  </div>
                  
                  <div className="p-4 border rounded-lg">
                    <h4 className="font-medium text-orange-800">Maintenance Contract Optimization</h4>
                    <p className="text-sm text-gray-600">Potential savings: $5,200/year</p>
                    <p className="text-xs text-gray-500">Renegotiate maintenance contracts for better rates</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Detailed audit trail for regulatory compliance</CardDescription>
                </div>
                <div className="flex gap-2">
                  <div className="relative">
                    <Search className="absolute left-3 top-3 h-4 w-4 text-gray-400" />
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Create and manage custom reports with flexible parameters</CardDescription>
                </div>
                <Button onClick={() => setShowCustomReportModal(true)}>
                  <Plus className="w-4 h-4 mr-2" />
                  New Report
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select value={customReportForm.type} onValueChange={(value) => setCustomReportForm({...customReportForm, type: value})}>
                  <SelectTrigger>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <Select value={customReportForm.schedule} onValueChange={(value) => setCustomReportForm({...customReportForm, schedule: value})}>
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select value={customReportForm.format} onValueChange={(value) => setCustomReportForm({...customReportForm, format: value as 'PDF' | 'Excel' | 'CSV'})}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setCustomReportForm({...customReportForm, recipients: e.target.value})}
