...
export default function Procurement() {
  ...
  const jobRequests: JobRequest[] = [
    {
      ...
      description:
        "We need a senior software developer with expertise in React and Node.js...",
    ...
    },
    {
      ...
      description:
        "Looking for a creative UI/UX designer with strong portfolio...",
    ...
    },
    {
      ...
      description:
        "DevOps engineer to manage cloud infrastructure and CI/CD pipelines...",
  ...
  const handleCandidateSubmit = (jobId: string) => {
    ...
    if (jobIndex !== -1) {
      ...
      jobRequests[jobIndex].selectedCandidate =
        updatedCandidate as CandidateInfo;
    }
    ...
    setCandidateForm({});
    alert(
      "Candidate information saved and provisioning tickets generated successfully!",
    );
  };

  const generateProvisioningTickets = (
    jobId: string,
    candidateName: string,
  ) => {
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div>
                <span className="font-medium">Expected DOJ:</span>{" "}
                {job.expectedDoj}
              </div>
              <div>
        ...
        {job.selectedCandidate && (
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <span className="font-medium">Actual DOJ:</span>{" "}
                {job.selectedCandidate.actualDoj}
              </div>
            </div>
          </div>
        )}
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button
              onClick={() =>
                selectedJob && handleCandidateSubmit(selectedJob.id)
              }
            >
    ...
    <div className="px-6 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Process job requests and manage candidate onboarding
        </p>
      </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {jobRequests.filter((j) => j.status === "New").length}
                </p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {jobRequests.filter((j) => j.status === "In Review").length}
                </p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {
                    jobRequests.filter((j) => j.status === "Candidate Selected")
                      .length
                  }
                </p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {jobRequests.filter((j) => j.status === "Processed").length}
                </p>
              </div>
        ...
        <TabsContent value="inbox" className="space-y-6">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <Select value={statusFilter} onValueChange={setStatusFilter}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Candidate Selected">
                      Candidate Selected
                    </SelectItem>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Incoming job requests from managers
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
        ...
        <TabsContent value="candidates" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage selected candidates and update joining details
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {jobRequests
                  .filter((job) => job.selectedCandidate)
                  .map((job) => (
        ...
        <TabsContent value="tickets" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Auto-generated tickets for asset allocation and account creation
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
