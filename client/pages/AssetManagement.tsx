  ...
  const handleAllocationSubmit = () => {
    ...
    allocationForm.assetIds.forEach((assetId) => {
      ...
      if (assetIndex !== -1) {
        ...
        assets[assetIndex].assignedDate = new Date()
          .toISOString()
          .split("T")[0];
        ...
        {asset.assignedTo && (
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <span className="font-medium">Job ID:</span> {asset.jobId}
              </div>
            </div>
          </div>
        )}
        ...
        <TabsContent value="allocations" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Monitor all asset assignments and their current status
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Assets that should have been returned
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {allocations
                    ...
                    .map((allocation) => (
                      <div
                        key={allocation.id}
                        className="p-4 border rounded-lg border-red-200"
                      >
                        <div className="flex justify-between items-start mb-2">
                          <div>
                            <h3 className="font-medium">
                        ...
                        <div className="flex gap-2 mt-3">
                          ...
                          <Button size="sm">Force Return</Button>
                        </div>
                      </div>
                    ))}
                </div>
        ...
        <TabsContent value="requests" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage asset allocation, return, and replacement requests
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="lg:col-span-2">
              <CardHeader>
                ...
                <CardDescription>
                  Asset Management Portal connectivity and sync status
                </CardDescription>
              </CardHeader>
              <CardContent>
      ...
      <Dialog open={showAllocationModal} onOpenChange={setShowAllocationModal}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Allocate {allocationForm.assetIds.length} selected asset(s) to an
              employee
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={handleAllocationSubmit}>Allocate Assets</Button>
            </div>
          </div>
        </DialogContent>
      </Dialog>
